...
public class Domain_maggiefice extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.domain_des)).setText("Enterprise | Realise | Enfranchise ");


        RecyclerView rv = (RecyclerView) view.findViewById(R.id.rv_recycler_view);
        rv.setHasFixedSize(true);
        MyAdapter_DMag adapter = new MyAdapter_DMag(new String[]{"The Indian Eye", "Hired or Fired", "Man with a Plan","Aaruush Premiere League"});
